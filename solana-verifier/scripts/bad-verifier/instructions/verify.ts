...
export type VerifyInstruction<
  TProgram extends string = typeof TEST_BAD_VERIFIER_PROGRAM_ADDRESS,
...
export function getVerifyInstruction<
  TAccountSystemProgram extends string,
  TProgramAddress extends Address = typeof TEST_BAD_VERIFIER_PROGRAM_ADDRESS,
>(
  ...
  const programAddress =
    config?.programAddress ?? TEST_BAD_VERIFIER_PROGRAM_ADDRESS;
