...
export function getEmergencyStopWithProofInstructionDataEncoder(): FixedSizeEncoder<EmergencyStopWithProofInstructionDataArgs> {
...
export function getEmergencyStopWithProofInstructionDataCodec(): FixedSizeCodec<
